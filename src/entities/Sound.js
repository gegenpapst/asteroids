...
class Sound {
  ...
  _tone(freq, endFreq, dur, type = "square", vol = 0.2) {
    ...
    try {
      ...
      if (endFreq !== freq) osc.frequency.exponentialRampToValueAtTime(endFreq, now + dur);
  ...
  shoot() {
    this._tone(820, 180, 0.11, "square", 0.1);
  }
  explodeLarge() {
    this._tone(110, 35, 0.5, "sawtooth", 0.28);
  }
  explodeMed() {
    this._tone(170, 60, 0.3, "sawtooth", 0.22);
  }
  explodeSmall() {
    this._tone(240, 110, 0.15, "sawtooth", 0.17);
  }
  shipDie() {
    this._tone(190, 28, 0.85, "sawtooth", 0.32);
  }
